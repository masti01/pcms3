        ...
        if r.status_code != requests.codes.ok \
           or r.status_code in self.HTTPignore:
            ...
            pywikibot.output('*[{}]:{} links to {} - {}.'
                             .format(datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S"), self.page.title(as_link=True), self.url,
                                     message))
            ...
            pywikibot.output(
                ...
                .format(datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S"), self.url, self.page.title(as_link=True)))
