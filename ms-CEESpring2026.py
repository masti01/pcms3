...
"""
Call:
    python pwb.py masti/ms-CEESpring2026.py -page:"Wikipedia:CEE Spring 2026/info" -outpage:"meta:Wikimedia CEE Spring 2026/Statistics" -summary:"Bot updates statistics" -reset -progress -pt:0
    python pwb.py masti/ms-CEESpring202.py -page:"Wikipedia:CEE Spring 2026/info" -outpage:"Wikipedysta:Masti/CEE Spring 2026" -summary:"Bot updates statistics" -reset -progress -pt:0
...
SpringStart = datetime.strptime("2026-03-21T00:59:59Z", "%Y-%m-%dT%H:%M:%SZ")
...
countryNames = {
    ...
    'de': {'Albanien': 'Albania', 'Österreich': 'Austria', 'Aserbaidschan': 'Azerbaijan',
           ...
           'Iran': 'Iran', 'Usbekistan': 'Uzbekistan', 'Kirgistan': 'Kyrgyzstan', },
    # bs countries
    ...
    'mk': {'Албанија': 'Albania', 'Австрија': 'Austria', 'Азербејџан': 'Azerbaijan', 'Башкортостан': 'Bashkortostan',
           ...
           'Западноерменски јазик': 'Western Armenian', 'Западноерменски': 'Western Armenian',
           ...
           'Северен Кавказ': 'North Caucasus', 'Новгородска Област': 'Novgorodian',  },
    # ro countries
    'ro': {'Albania': 'Albania', 'Austria': 'Austria', 'Azerbaidjan': 'Azerbaijan', 'Bașkortostan': 'Bashkortostan',
           ...
           'Crimeea': 'Crimea', 'Lituania': 'Lithuania', 'Letonia': 'Latvia', 'Ungaria': 'Hungary',
           ...
           'Malta': 'Malta', 'Tătari crimeeni': 'Crimean Tatars', 'Tătarii din Crimeea': 'CCrimean Tatars',
           ...
           'Aromâni': 'Aromanian', 'romi': 'Romani', 'Armenia de Vest': 'Western Armenian', 'Iacutia': 'Sakha',
           'caraiți crimeeni': 'Crimean Karaites', 'crimceaci': 'Krymchaks', 'tătari crimeeni': 'Crimean Tatars',
    ...
    'ru': {'Албания': 'Albania', 'Австрия': 'Austria', 'Азербайджан': 'Azerbaijan', 'Башкортостан': 'Bashkortostan',
           ...
           'Western Armenian': 'Western Armenian', 'Erzya': 'Erzya', 'Western Armenian community': 'Western Armenian',
           'Cyprus': 'Cyprus', 'Kazakhstan': 'Kazakhstan', 'Якутия': 'Sakha', 'Татары': 'Tatars',
           'Crimean tatars': 'Crimean Tatars', 'Эрзяне': 'Erzia', 'Западноармянская община': 'Western Armenian',
    ...
    'sah': {
            ...
            'Беларусь': 'Belarus', 'Эрзя': 'Erzia', 'Грузия': 'Georgia',
    },
    # sq countries
    ...
    'tt': {'Албания': 'Albania', 'Австрия': 'Austria', 'Әзербайҗан': 'Azerbaijan', 'Азәрбайҗан': 'Azerbaijan',
           ...
           'Кыргызстан': 'Kyrgyzstan', 'Рәсәй Федерациясе': 'Russia',
           },
    # tr countries
    ...
    'hr': {'Albaniji': 'Albania', 'Albanija': 'Albania', 'Austriji': 'Austria', 'Austrija': 'Austria',
           ...
           'Baškiriji': 'Bashkortostan', 'Kosovi': 'Kosovo', 'international': 'International', 'Tatari': 'Tatars',
           'Crne Gore': 'Montenegro', 'Roma (Romani)': 'Romani', },
    # sl countries
    ...
    def getArticleList(self):
        ...
        for p in self.generator:
            ...
            for i in self.genInterwiki(p):
                ...
                # test switch
                if self.opt.short:
                    if lang not in (['sl']):  # keep parentheses for list
                        continue
