...
countryList = [u'Albania', u'Armenia', u'Austria', u'Azerbaijan', u'Bashkortostan', u'Belarus',
               ...
               u'Lithuania', u'North Macedonia', u'Malta', u'Montenegro', u'Poland', u'Romania and Moldova',
               u'Republic of Srpska', u'Russia', u'Serbia', u'Sorbia', u'Slovakia', u'Slovenia', u'Tatarstan',
               u'Turkey', u'Ukraine', u'Other', u'Empty']
...
countryNames = {
    ...
    'pl': {'Albania': 'Albania', 'Austria': 'Austria', 'Azerbejdżan': 'Azerbaijan', 'Baszkortostan': 'Bashkortostan',
           'Białoruś': 'Belarus', 'Bułgaria': 'Bulgaria', 'Armenia': 'Armenia',
    ...
    'ba': {'Албания': 'Albania', 'Австрия': 'Austria', 'Әзербайжан': 'Azerbaijan', 'Башҡортостан': 'Bashkortostan',
           ...
           'Ҡырым': 'Crimean Tatars', 'Эсперанто': 'Esperanto', },
    # be countries
    ...
    'de': {'Albanien': 'Albania', 'Österreich': 'Austria', 'Aserbaidschan': 'Azerbaijan',
           ...
           'Nordmazedonien': 'North Macedonia', 'Tatarstan': 'Tatarstan',
           'die Republik Moldau': 'Romania and Moldova', },
    # crh countries
    ...
    'uk': {'Албанія': 'Albania', 'Австрія': 'Austria', 'Азербайджан': 'Azerbaijan', 'Башкортостан': 'Bashkortostan',
           ...
           'Греція': 'Greece', 'Казахстан': 'Kazakhstan', 'Мальта': 'Malta', },
    # hu countries
    ...
    'sl': {'Albanija': 'Albania', 'Armenija': 'Armenia', 'Avstrija': 'Austria', 'Azerbajdžan': 'Azerbaijan',
           ...
           'Republika srbska': 'Republic of Srpska', 'Moldavija': 'Romania and Moldova', },
    # mt countries
...
class BasicBot(
    ...
    topicp = {'pl': 'parametr', 'az': 'qadınlar', 'ba': 'тема', 'be': 'тэма', 'be-tarask': 'тэма', 'bg': 'тема',
              ...
              'ro': 'secțiune', 'ru': 'тема', 'sl': 'tema', 'sk': 'Parameter', 'sq': 'topic', 'sr': 'тема',
    ...
    womenp = {'pl': 'kobiety', 'az': 'qadınlar', 'ba': 'Ҡатын-ҡыҙҙар', 'be': 'Жанчыны', 'be-tarask': 'жанчыны',
              'bg': 'жени', 'de': 'Frauen', 'el': 'γυναίκες', 'et': 'naised', 'ka': 'ქალები', 'lv': 'Sievietes',
              'mk': 'Жени', 'ro': 'Femei', 'ru': 'женщины', 'sl': 'Ženske',
    ...
    userp = {'pl': 'autor', 'az': 'istifadəçi', 'ba': 'ҡатнашыусы', 'be': 'удзельнік', 'be-tarask': 'удзельнік',
             'bg': 'потребител', 'de': 'benutzer', 'crh': 'qullanıcı', 'el': 'user', 'et': 'kasutaja',
             'hu': 'szerkesztő', 'eo': 'uzanto',
             'ka': 'მომხმარებელი', 'lv': 'dalībnieks', 'lt': 'naudotojas', 'mk': 'корисник', 'mt': 'utent',
             'myv': 'сёрмадыця', 'ro': 'utilizator', 'ru': 'участник',
        ...
        for l in res.keys():
            ...
            for i in res[l]:
                ...
                if i['newarticle']:
                    ...
                    newartscount += 1
                    artLine = u'\n|-\n| %i. || [[:%s:%s]] || %s || %s || ' % (
                        newarts, i['lang'], i['title'], i['creator'], i['creationDate'])
                    cList = []
